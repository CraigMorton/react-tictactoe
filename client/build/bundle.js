...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TickTackToeContainer = __webpack_require__(159);
	
	var _TickTackToeContainer2 = _interopRequireDefault(_TickTackToeContainer);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	window.onload = function () {
	  _reactDom2.default.render(_react2.default.createElement(_TickTackToeContainer2.default, null), document.getElementById('app'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _gameLogic = __webpack_require__(162);
	...
	var TickTackToeContainer = function (_React$Component) {
	  _inherits(TickTackToeContainer, _React$Component);
	
	  function TickTackToeContainer(props) {
	    _classCallCheck(this, TickTackToeContainer);
	
	    var _this = _possibleConstructorReturn(this, (TickTackToeContainer.__proto__ || Object.getPrototypeOf(TickTackToeContainer)).call(this, props));
	  ...
	  _createClass(TickTackToeContainer, [{
	    key: 'handleCellClick',
	    ...
	    value: function render() {
	      (0, _gameLogic.isGameFinished)(this.state.grid);
	  ...
	  return TickTackToeContainer;
	}(_react2.default.Component);
	
	exports.default = TickTackToeContainer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Board = function Board(props) {
	  return _react2.default.createElement(
	    'div',
	    null,
	    props.grid.map(function (cell, index) {
	      console.log(cell);
...
/***/ function(module, exports) {
	...
	var isGridComplete = function isGridComplete(grid) {
	  ...
	  // Alex's OOP version
	  var claimedness = grid.map(function (cell) {
	    return cell.claimed;
	  });
	  for (var i = 0; i < claimedness.length; i++) {
	  ...
	  return grid.some(function (cell) {
	    return !cell.claimed;
	  });
	};
	
	exports.isGridComplete = isGridComplete;
